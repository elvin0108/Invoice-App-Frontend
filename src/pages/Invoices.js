...
const Invoices = () => {
  return (
    <div className='invoices-nav'>
      ...
      <div class="invoice-icon"><IoIcons.IoIosCreate /></div>
          <div className='invoice-box-text'>Create Invoice</div>
      </Link>
      <Link to="/invoices/manage"  className='invoice-box'>
      <div class="invoice-icon"><MdIcons.MdOutlineManageAccounts /></div>
          <div className='invoice-box-text'>Manage Invoice</div>
      </Link>
      <Link to="/invoices/manage"  className='invoice-box'>
        <div class="invoice-icon"><AiIcons.AiOutlineCloudDownload /></div>
